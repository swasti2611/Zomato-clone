...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: ` https://glacial-plateau-78553.herokuapp.com/restaurant/${restaurant}`,
            method: 'GET',
    ...
    handleOrder = () => {
        ...
        axios({
            url: `   https://glacial-plateau-78553.herokuapp.com/menuitems/${restaurantId}`,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        })
            .then(respone => {
    ...
    getData = (data) => {
        return fetch(` https://glacial-plateau-78553.herokuapp.com/payment`, {
            method: "POST",
            headers: {
